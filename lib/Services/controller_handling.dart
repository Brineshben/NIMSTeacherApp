...
class HandleControllers {
  static createGetControllers() {
    ...
    Get.put(Notificationcliniccontroller());
    Get.put(HomeController());
    Get.put(FeedDBController());
    Get.put(ParentDbController());
    Get.put(GroupDbController());
    ...
    Get.find<GroupDbController>().initDatabaseForChat();
  }
  ...
  static deleteAllGetControllers() {
    ...
    Get.delete<RecentDateListApiController>();
